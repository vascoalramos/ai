...
print(z.query2("homem", "mamar"))  # alinea (12)
print(z.query_cancel("socrates", "altura"))  # alinea (13)
print(z.query_down("mamifero", "altura")) # alinea (14)
print(z.query_induce("mamifero", "altura")) # alinea (15)
print(z.query_local_assoc("socrates", "pai")) # alinea (16)
print(z.query_local_assoc("socrates", "pulsacao")) # alinea (16)
print(z.query_local_assoc("homem", "gosta")) # alinea (16)